...
INSERT INTO "new_Posting" ("category", "closedAt", "description", "discoveredAt", "dismissedAt", "duplicateRejected", "externalId", "id", "lastSeenAt", "location", "missedRuns", "organization", "possibleDuplicateOfId", "postedAt", "region", "salary", "seniority", "sourceId", "title", "url", "workMode") SELECT "category", "closedAt", "description", "discoveredAt", "dismissedAt", "duplicateRejected", "externalId", "id", "lastSeenAt", "location", "missedRuns", "organization", "possibleDuplicateOfId", "postedAt", "region", "salary", "seniority", "sourceId", "title", "url", "workMode" FROM "Posting";
DROP TABLE "Posting";
