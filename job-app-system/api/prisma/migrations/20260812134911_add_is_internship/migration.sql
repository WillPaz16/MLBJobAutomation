...
CREATE TABLE "new_Posting" (
    ...
    "isMlbTeam" BOOLEAN NOT NULL DEFAULT false,
    "sourceSection" TEXT,
...
INSERT INTO "new_Posting" ("category", "closedAt", "description", "discoveredAt", "dismissedAt", "duplicateRejected", "externalId", "id", "isMlbTeam", "lastSeenAt", "location", "missedRuns", "organization", "possibleDuplicateOfId", "postedAt", "region", "salary", "seniority", "sourceId", "sourceSection", "title", "url", "workMode") SELECT "category", "closedAt", "description", "discoveredAt", "dismissedAt", "duplicateRejected", "externalId", "id", "isMlbTeam", "lastSeenAt", "location", "missedRuns", "organization", "possibleDuplicateOfId", "postedAt", "region", "salary", "seniority", "sourceId", "sourceSection", "title", "url", "workMode" FROM "Posting";
DROP TABLE "Posting";
